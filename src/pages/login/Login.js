...
import { Nav, NavItem, NavLink, Button, FormGroup, Input, Row, Col, Form, Label } from 'reactstrap';
          ...
          <Row>
            <Col className="col-md-4 login-sec">
              ...
              <Nav className="nav-pills nav-fill nav-header">
                <NavItem>
                  <NavLink
                    className={this.state.role === 'admin' ? 'active' : ''}
                    onClick={() => this.changeLoginActor('admin')}
                  >
                    Admin
                  </NavLink>
                </NavItem>
                ...
                <NavItem>
                  <NavLink
                    className={this.state.role === 'lecturer' ? 'active' : ''}
                    onClick={() => this.changeLoginActor('lecturer')}
                  >
                    Lecturer
                  </NavLink>
                </NavItem>
                ...
                <NavItem>
                  <NavLink
                    className={this.state.role === 'student' ? 'active' : ''}
                    onClick={() => this.changeLoginActor('student')}
                  >
                    Student
                  </NavLink>
                </NavItem>
              ...
              <p className={this.state.errorMessage ? 'alert alert-danger' : ''}>
                {' '}
