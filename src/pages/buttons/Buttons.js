        ...
        <Row>
          ...
          <Col md={6} sm={12} xs={12}>
            <Widget
              title={
                <h5>
                  {' '}
                  Color <span className="fw-semi-bold">Options</span>
                </h5>
              }
              close
              collapse
          ...
          <Col md={6} sm={12} xs={12}>
            <Widget
              title={
                <h5>
                  {' '}
                  Size <span className="fw-semi-bold">Variants</span>
                </h5>
              }
              close
              collapse
            >
              <div>
                <p className="fs-mini text-muted">
                  Fancy larger or smaller buttons? Four separate sizes available for all use cases:
          ...
          <Col md={6} sm={12} xs={12}>
            <Widget
              title={
                <h5>
                  Outline <span className="fw-semi-bold">Buttons</span>
                </h5>
              }
              close
              collapse
            >
              <div>
                <p className="fs-mini">
                  ...
                  <code>outline</code> property to remove all background images and colors on any
                  button.
                </p>
                <p>
          ...
          <Col md={6} sm={12} xs={12}>
            <Widget
              title={
                <h5>
                  Rounded <span className="fw-semi-bold">Buttons</span>
                </h5>
              }
              close
              collapse
            >
              <div>
                <p className="fs-mini">
                  ...
                  Semantically distinguishable beauty. Use <code>.btn-rounded</code> or{' '}
                  <code>.btn-rounded-f</code>.
                </p>
                <p>
                  <Button color="default" className="btn-rounded-f width-100 mb-xs mr-xs">
                    Default
                  </Button>
                  <Button color="primary" className="btn-rounded-f width-100 mb-xs mr-xs">
                    Primary
                  </Button>
                  <Button color="info" className="btn-rounded-f width-100 mb-xs mr-xs">
                    Info
                  </Button>
                  <Button color="success" className="btn-rounded-f width-100 mb-xs mr-xs">
                    Success
                  </Button>
                  <Button outline color="warning" className="btn-rounded width-100 mb-xs mr-xs">
                    Warning
                  </Button>
                  <Button outline color="danger" className="btn-rounded width-100 mb-xs mr-xs">
                    Danger
                  </Button>
                  <Button outline color="gray" className="btn-rounded width-100 mb-xs mr-xs">
                    Gray
                  </Button>
                  <Button outline color="inverse" className="btn-rounded width-100 mb-xs mr-xs">
                    Inverse
                  </Button>
                </p>
              </div>
          ...
          <Col md={6} sm={12} xs={12}>
            <Widget
              title={
                <h5>
                  {' '}
                  Block <span className="fw-semi-bold">Buttons</span>
                </h5>
              }
              close
              collapse
          ...
          <Col md={6} sm={12} xs={12}>
            <Widget
              title={
                <h5>
                  {' '}
                  Disabled <span className="fw-semi-bold">Buttons</span>
                </h5>
              }
              close
              collapse
            >
              <div>
                <p className="fs-mini text-muted">
                  ...
                  <code>disabled</code> to <code>&lt;Button&gt;</code> component.
                </p>
                <p>
                  <Button color="primary" disabled className="mr-xs">
                    Primary button
                  </Button>
                  <Button color="default" disabled className="mr-xs">
                    Button
                  </Button>
                </p>
                <p>
                  <Button color="success" size="sm" disabled className="mr-xs">
                    Primary Link
                  </Button>
                  <Button color="default" size="sm" disabled className="mr-xs">
                    Link
                  </Button>
                </p>
              </div>
            ...
            >
              <div>
                <p className="fs-mini text-muted">
                  ...
                  optional JavaScript radio and checkbox style behavior with Bootstrap buttons
                  plugin.
                </p>
          ...
          <Col md={6} sm={12} xs={12}>
            ...
            >
              <div>
                <p className="fs-mini text-muted">
                  Add dropdown menus to nearly anything with this simple plugin, including the
                  buttons, navbar, tabs, and pills. Both solid & segmented dropdown options
                  available.
                </p>
              ...
              <Row>
                ...
                <Col md={4} sm={6} xs={12}>
                  ...
                  <p className="fs-mini text-muted">
                    ...
                    components like toolbars. Use <code>ButtonGroup</code> to a group of checkboxes
                ...
                <Col md={4} sm={12} xs={12}>
                  ...
                  <p className="fs-mini text-muted">
                    Do more with buttons. Control button states or create groups of buttons for more
                    components like toolbars. Use <code>ButtonGroup</code> to a group of radio
                ...
                <Col md={4} sm={12} xs={12}>
                  ...
                  <p className="fs-mini text-muted">
                    Fontawesome and Glyph- icons may be used in buttons, button groups for a
                    toolbar, navigation, or prepended form inputs. Let your buttons shine!
                  </p>
